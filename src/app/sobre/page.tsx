...
export const metadata: Metadata = {
  title: "Sobre BØLG Atlas",
  description:
    "Cómo funciona el Atlas BØLG y qué pasa cuando subes tu primer viaje.",
};
        ...
        <section className="flex flex-col gap-12">
          ...
          <ol className="grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-6 lg:gap-10">
            ...
            <Step
              ...
              body="Lugar, fechas, foto, los BØLG que llevaste. Calculamos los kilómetros automático."
            />
            <Step
              n={3}
              icon={Package}
